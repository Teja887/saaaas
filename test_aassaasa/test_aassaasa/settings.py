"""
Django settings for test-everything project.
...
SECRET_KEY = env("SECRET_KEY", default="IcbSDCtGhywICmUBMbwFgcKSShLsRiLVldDjVHtr")
...
ROOT_URLCONF = "test_aassaasa.urls"
...
WSGI_APPLICATION = "test_aassaasa.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="test_aassaasa"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "test_aassaasa_language"
LANGUAGES = [
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="test_aassaasa-media")
...
EMAIL_SUBJECT_PREFIX = "[test-everything] "
...
ASGI_APPLICATION = "test_aassaasa.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
LOGGING = {
    ...
    "loggers": {
        ...
        "test_aassaasa": {
            "handlers": ["console"],
            "level": env("TEST_AASSAASA_LOG_LEVEL", default="INFO"),
        },
    },
}
